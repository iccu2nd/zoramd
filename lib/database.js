...
// Hanya flush BOT_DATA (users/chats). BOT_SETTINGS ditulis lewat
// botSettingsService / API dashboard — jangan di-overwrite tiap 30 detik
// supaya perubahan dari Bot Settings tidak hilang.
...
export function stopDatabaseFlush() {
