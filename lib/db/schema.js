...
export const COLLECTIONS = {
    ...
    EMAIL_TOKENS: 'email_tokens' // kode OTP (verifikasi email, reset password) per email+type, auto-expire
}
...
export async function ensureIndexes() {
    ...
    await db.collection(COLLECTIONS.EMAIL_TOKENS).createIndex({ expiresAt: 1 }, { expireAfterSeconds: 0 })
