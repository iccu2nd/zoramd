...
export const ACCESS_FLAGS = ['owner', 'admin', 'premium', 'verified', 'group', 'private']
...
export async function getFeatureSetting(botId, featureKey) {
    ...
    return {
        ...
        customResponse: null,
        customCommand: null,
        // Extended Bot Control Center fields
        cooldown: 0,           // seconds, 0 = off
        limitCost: 1,          // limit units consumed per use
        requireVerified: false,
        premiumOnly: false,
        // Result / output customization (optional, plugin-aware)
        resultCaption: null,
        resultFooter: null,
        resultLoading: null,
        resultSuccess: null,
