    ...
    async start(opts = {}) {
        ...
        try {
            ...
            sock.ev.on('group-participants.update', (event) => {
                Promise.resolve(onParticipantsUpdate(sock, cfg, event)).catch(() => {})
            })
            // Command handler aktif segera; jangan biarkan unhandled rejection crash process
            sock.ev.on('messages.upsert', (event) => {
                Promise.resolve(handleMessage(sock, cfg, event)).catch(e =>
